...
do_pgfault(struct mm_struct *mm, uint32_t error_code, uintptr_t addr) {
    ...
    pte_t *ptep=NULL;
    /*LAB3 EXERCISE 1: 2012080061 李载隆
    ...
    */
    ...
    /*LAB3 EXERCISE 2: 2012080061 李载隆
    ...
    *    page_insert 竊build the map of phy addr of an Page with the linear addr la
    *    swap_map_swappable 竊set the page swappable
    */
    /*
     ...
     */
        if(swap_init_ok) {
            struct Page *page=NULL;
                                    //(1竊덦ccording to the mm AND addr, try to load the content of right disk page
